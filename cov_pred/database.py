...
class Database:
    ...
    def get_commit_hash(self, registry) -> str | None:
        self.open_cur()
    ...
    def get_logs(self, registry) -> list[dict[str, str]]:
        self.open_cur()
    ...
    def get_signatures(self, registry_id: str) -> list[str]:
        self.open_cur()
    ...
    def get_execution_path(self, registry, signature) -> list[dict[str, str]]:
        self.open_cur()
